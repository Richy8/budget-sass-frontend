...
const BudgetDisplayLoader = () => {
  return (
    <div className="loading-card bg-yellow-100/20 pt-6 pb-10 min-h-[400px] h-auto flex flex-col justify-center items-center w-full">
      <Image
        src={BlockLoader}
        alt="block-loader"
        className="mb-1"
...
export default BudgetDisplayLoader;
