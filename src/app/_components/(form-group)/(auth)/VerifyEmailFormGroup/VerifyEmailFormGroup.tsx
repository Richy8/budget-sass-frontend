...
const VerifyEmailFormGroup = () => {
  ...
  return (
    <AuthContainer
      ...
      secondaryText="We sent a verification code to your email"
      showSocialAuth={false}
    >
      {/* FORM BLOCK */}
      <form className="form-block" onSubmit={handleCodeVerification}>
        {/* EMAIL DISPLAY */}
        <div className="text-sm text-teal-600 font-medium -mt-[30px] mb-9">
        ...
        <div className="helper-row mt-4 mb-6">
          <div className="text flex justify-start items-center gap-x-1.5">
            {`Didn't get a code?`}
            {isSendingCode ? (
              <div className="text-teal-600">Resending...</div>
            ) : (
              <div
